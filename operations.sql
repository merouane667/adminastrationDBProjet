...
INSERT INTO Boutique (id,nom, vendeur_id) VALUES ('NouvelleBoutique', 1);

-- Ajouter un employé à votre boutique
INSERT INTO Employe (id,nom, prenom, boutique_id) VALUES ('NouvelEmploye', 'PrenomNouvelEmploye', 2);

-- Ajouter un produit à votre boutique
INSERT INTO Produit (id,nom, description, boutique_id) VALUES ('NouveauProduit', 'DescriptionNouveauProduit', 2);
